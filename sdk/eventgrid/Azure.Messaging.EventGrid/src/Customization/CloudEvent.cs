...
namespace Azure.Messaging.EventGrid.Models
{
    ...
    public partial class CloudEvent : IDictionary<string, object>
    {
        ...
        internal CloudEvent(string id, string source, BinaryData data, string type, DateTimeOffset? time, string specversion, string dataschema, string datacontenttype, string subject, IDictionary<string, object> additionalProperties)
        {
            Id = id;
            Source = source;
            Data = data;
